...
describe('TextSummaryPipe', () => {
  ...
  it('should return the same string if the length of input is less than or equal to the limit', () => {
  ...
  it('should assume 10 as the limit if the limit is not given', () => {
    expect(pipe.transform('1234567890123456')).toEqual('1234567890...');
  });
});
