...
describe('VoterComponent', () => {
  ...
  describe('When I upvote,', () => {
    it('should increment total votes', () => {
      ...
      // When testing components, I think of them as a black box or a DVD player. When we press
      ...
      // hundreds of ICs, transistors, etc. By the same token, we don't care about the value of individual
